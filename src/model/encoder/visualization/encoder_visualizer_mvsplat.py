...
from ..encoder_mvsplat import EncoderMVSplat
...
class EncoderVisualizerMVSplat(
    EncoderVisualizer[EncoderVisualizerCostVolumeCfg, EncoderMVSplat]
):
    def visualize(
        self,
        ...
        return {
            ...
            "depth_wo_refine": self.visualize_depth_wo_refine(
                context,
